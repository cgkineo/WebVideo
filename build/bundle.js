...
var Event = function Event() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$path = _ref.path,
      path = _ref$path === void 0 ? [target] : _ref$path,
...
var EventAttachment = /*#__PURE__*/function () {
  function EventAttachment(options) {
...
function parseEventsArgumentNotation(name, callback, subject, each, that) {
  if (name instanceof Object) {
    ...
    for (var _i = 0, _l = _names.length; _i < _l; _i++) {
      var _eventName = _names[_i];
      each.call(that, _eventName, callback, subject);
    }
...
var Events = /*#__PURE__*/function () {
  ...
  _createClass(Events, [{
    key: "listenTo",
    value: function listenTo(subject, name, callback) {
      var _this = this;

      parseEventsArgumentNotation(name, callback, subject, function (name, callback, subject) {
        new EventAttachment({
          from: subject,
          to: _this,
          context: _this,
    ...
    key: "listenToOnce",
    value: function listenToOnce(subject, name, callback) {
      var _this2 = this;
    ...
    key: "stopListening",
    value: function stopListening(subject, name, callback) {
    ...
    value: function off(name, callback, context) {
      ...
      parseEventsArgumentNotation(name, callback, context, function (name, callback) {
        if (!_this4.events) return;

        for (var i = _this4.events.length - 1; i > -1; i--) {
          var event = _this4.events[i];
          if (event.from.events !== _this4.events) continue;
          if (name !== null && event.name !== name) continue;
          if (callback !== null && event.callback !== callback) continue;
          event.destroy();
        }
    ...
    value: function trigger(name) {
      ...
      for (var _i2 = events.length - 1; _i2 > -1; _i2--) {
        var _event = events[_i2];

        if (_event.name === "*") {
          _event.callback.apply(_event.context, arguments);
        } else {
          _event.callback.apply(_event.context, args);
        }

        if (!_event.once) continue;
...
var Stream = /*#__PURE__*/function (_Events) {
  ...
  function Stream(options) {
    ...
    _this.on({
      ...
      "unpipe": _this.removeDestination,
      "drain": _this.addSource,
      "undrain": _this.removeSource
    });
  ...
  _createClass(Stream, [{
    ...
    key: "drain",
    value: function drain(source) {
      var _this2 = this;

      var inputIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

      if (arguments.length === 1 && source instanceof Array) {
        source.forEach(function (source, inputIndex) {
          source.trigger('pipe', _this2);

          _this2.trigger('drain', source, inputIndex);
        });
        return this;
      }
    ...
    value: function addSource(source) {
      ...
      this.listenTo(source, {
        changed: function changed(event) {
          _this3.sourceLastChanged[inputIndex] = Date.now();
          event = new _Event__WEBPACK_IMPORTED_MODULE_1__["default"](event);
          event.path.push(_this3);

          _this3.onSourceChanged(event, inputIndex);
        }
      });
    }
    /**
    ...
    value: function undrain(source) {
      ...
      if (arguments.length === 1 && source instanceof Array) {
        source.forEach(function (source, inputIndex) {
          source.trigger('unpipe', _this4);

          _this4.trigger('undrain', source, inputIndex);
        });
        return this;
      }
    ...
    value: function changed() {
      ...
      var inputIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
      event = event || new _Event__WEBPACK_IMPORTED_MODULE_1__["default"]({
        name: 'changed',
        target: this
      });
...
var Streams = /*#__PURE__*/function () {
  ...
  _createClass(Streams, [{
    key: "pipe",
    value: function pipe(destination) {
      this.items.forEach(function (source, index) {
    ...
    key: "drain",
    value: function drain(source) {
      this.items.forEach(function (destination) {
...
var WebGLShader = /*#__PURE__*/function () {
  ...
  function WebGLShader(context, textures) {
...
var WebGLTexture = /*#__PURE__*/function () {
  ...
  _createClass(WebGLTexture, [{
    ...
    key: "fromElement",
    value: function fromElement(context, element) {
      var texture = new WebGLTexture(context, 0, 0, context.RGBA, context.UNSIGNED_BYTE);
...
var Input = /*#__PURE__*/function (_Stream) {
  _inherits(Input, _Stream);
...
/* harmony import */ var _core_Stream__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/Stream */ "./src/core/Stream.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Stream", function() { return _core_Stream__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _core_Streams__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/Streams */ "./src/core/Streams.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Streams", function() { return _core_Streams__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _foundations_Input__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./foundations/Input */ "./src/foundations/Input.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Input", function() { return _foundations_Input__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _foundations_Output__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./foundations/Output */ "./src/foundations/Output.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Output", function() { return _foundations_Output__WEBPACK_IMPORTED_MODULE_4__["default"]; });
...
var Color = /*#__PURE__*/function (_Stream) {
  _inherits(Color, _Stream);
...
/***/ "./src/transformers/Displacement.js":
/*!******************************************!*\
  !*** ./src/transformers/Displacement.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Displacement; });
/* harmony import */ var _core_Stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/Stream */ "./src/core/Stream.js");
...
/* harmony import */ var _shaders_Displacement__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shaders/Displacement */ "./src/transformers/shaders/Displacement.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Displacement = /*#__PURE__*/function (_Stream) {
  _inherits(Displacement, _Stream);

  var _super = _createSuper(Displacement);
...
/* harmony import */ var _core_WebGL__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/WebGL */ "./src/core/WebGL.js");
/* harmony import */ var _core_WebGLTexture__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core/WebGLTexture */ "./src/core/WebGLTexture.js");
/* harmony import */ var _shaders_Fade__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shaders/Fade */ "./src/transformers/shaders/Fade.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/***/ "./src/transformers/shaders/Color.js":
/*!*******************************************!*\
  !*** ./src/transformers/shaders/Color.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/WebGLShader */ "./src/core/WebGLShader.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ColorShader = /*#__PURE__*/function (_WebGLShader) {
  ...
  _createClass(ColorShader, [{
    ...
    value: function parseUniforms(uniforms) {
      return {
        brightness: _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"].clamp(-1, uniforms.brightness, 1),
        contrast: _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"].clamp(-1, uniforms.contrast, 1),
        hue: _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"].clamp(-1, uniforms.hue, 1),
        saturation: _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"].clamp(-1, uniforms.saturation, 1)
      };
    }
  }, {
    key: "fragmentSource",
  ...
  return ColorShader;
}(_core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"]);



/***/ }),

/***/ "./src/transformers/shaders/Displacement.js":
/*!**************************************************!*\
  !*** ./src/transformers/shaders/Displacement.js ***!
  \**************************************************/
/*! exports provided: default */
...
var DisplacementShader = /*#__PURE__*/function (_WebGLShader) {
  ...
  _createClass(DisplacementShader, [{
    ...
    value: function parseUniforms(uniforms) {
      return {
        amount: _core_WebGLShader__WEBPACK_IMPORTED_MODULE_0__["default"].clamp(0, uniforms.amount, 1)
      };
    }
  }, {
    key: "fragmentSource",
...
/***/ "./src/transformers/shaders/Fade.js":
/*!******************************************!*\
  !*** ./src/transformers/shaders/Fade.js ***!
  \******************************************/
/*! exports provided: default */
...
/***/ "./src/transformers/shaders/Sepia.js":
/*!*******************************************!*\
  !*** ./src/transformers/shaders/Sepia.js ***!
  \*******************************************/
/*! exports provided: default */
